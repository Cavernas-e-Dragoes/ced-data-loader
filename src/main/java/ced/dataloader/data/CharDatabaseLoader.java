...
import ced.dataloader.repository.CharactersRepository;
...
public class CharDatabaseLoader implements ApplicationRunner {
    ...
    public void run(ApplicationArguments args)  {
        ...
        adno.setLogin("asa");
        adno.setName("Adno");
        adno.setRace(new Race(1L));
        adno.setCharClass(new CharClass(1L));
        ...
        adna.setLogin("asa");
        adna.setName("Adna");
        adna.setRace(new Race(1L));
        adna.setCharClass(new CharClass(5L));
        ...
        coisa.setLogin("asa");
        coisa.setName("Coisa");
        coisa.setRace(new Race(2L));
        coisa.setCharClass(new CharClass(3L));
        ...
        mingau.setRace(new Race(3L));
        mingau.setCharClass(new CharClass(3L));
        ...
        preta.setLogin("asa");
        preta.setName("Preta");
        preta.setRace(new Race(4L));
        preta.setCharClass(new CharClass(4L));
        ...
        doby.setLogin("asa");
        doby.setName("Doby");
        doby.setRace(new Race(5L));
        doby.setCharClass(new CharClass(5L));
        ...
        daleke.setRace(new Race(6L));
        daleke.setCharClass(new CharClass(6L));
        ...
        caroco.setRace(new Race(6L));
        caroco.setCharClass(new CharClass(6L));
        ...
        jake.setRace(new Race(5L));
        jake.setCharClass(new CharClass(6L));
        ...
        fifi.setLogin("asa");
        fifi.setName("A Fifi");
        fifi.setRace(new Race(5L));
        fifi.setCharClass(new CharClass(6L));
        ...
        kirito.setRace(new Race(5L));
        kirito.setCharClass(new CharClass(6L));
